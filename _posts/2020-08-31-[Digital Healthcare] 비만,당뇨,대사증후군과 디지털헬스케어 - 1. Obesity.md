...
의사의 입장에서 보면, 체중은 변동이 크지 않기 때문에 병원에서의 체중이 집에서의 체중을 어느정도는 반영하여 체중의 매일의 트렌드가 진료에는 의미가 있을 지는 모르겠다. 그러나 추후 비만의 치료 편에서 볼 눔("noom")같은 솔루션을 위해서 매일의 체중이 스마트폰과 연동되는 것은 개인의 건강관리에 도움은 될 것같다.
